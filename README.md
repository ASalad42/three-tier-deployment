...
- Access prometheus on Prometheus-LB-DNS
...
- Access grafana on Grafana-LB-DNS > setup connection > use HTTP://Prometheus-LB-DNS
...
- ![image](https://github.com/user-attachments/assets/4a66ef32-c969-4eb6-a3b8-df57c62809ab)
